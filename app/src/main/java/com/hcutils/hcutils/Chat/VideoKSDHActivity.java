...
public class VideoKSDHActivity extends BaseChatVideoActivity {
    ...
    @BindView(R.id.video_touser_personimage)
    ImageView videoTouserPersonimage;
    @BindView(R.id.video_touser_name)
    TextView videoTouserName;
    @BindView(R.id.video_touser_type)
    TextView videoTouserType;
    @BindView(R.id.video_touser_line)
    LinearLayout videoTouserLine;
    @BindView(R.id.video_jieshou)
...
////
    ...
    @OnClick({R.id.video_jieshou, R.id.video_cancel})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.video_jieshou:
                stopMusic();
