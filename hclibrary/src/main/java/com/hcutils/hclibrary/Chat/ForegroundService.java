...
public class ForegroundService extends Service {
    ...
    public Notification createCompatibleNotification(Context context) {
        NotificationChannel chan = new NotificationChannel(ID, "合云校通话", NotificationManager.IMPORTANCE_DEFAULT);

        NotificationManager service = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
        service.createNotificationChannel(chan);
        Intent intentChart = new Intent(this, BaseChatActivity.class);
